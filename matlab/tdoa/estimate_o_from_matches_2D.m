function [matches,o,res] = estimate_o_from_matches_2D(rawmatches,settings);
%[matches,o,res] = estiamate_o_from_matches(rawmatches,settings);
%

u = rawmatches.u;
ok = rawmatches.uok;
[o,v,uuu,A,inliers_ut,pp,cc]=tdoa_offset_ransac_2D(u,ok);
