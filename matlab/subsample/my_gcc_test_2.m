...
settings.frameSize = 2000;     %width of frame in sample points
settings.dx = 2000;            %distance between frames in sample points
...
figure(2); subplot(2,1,1); plot(tt2,scores1{1,2}(:,1)); 
subplot(2,1,2); plot(tt2,scores2{1,2}(:,1));
...
figure(4); subplot(2,1,1); plot(tt2,scores1{1,2}(:,1)); 
subplot(2,1,2); plot(tt2,scores2{1,2}(:,1));
