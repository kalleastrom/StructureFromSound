function out = estimate_trans_std_faster_2(opts,count)
% also uses offset
...
for kk = 1:N;
    ...
    for i = 1:nbr_channels
        channels{i} = true_offset(i)+F0(x+true_translation(i),a1);
    ...
    for i = 2:nbr_channels
        ...
        if 0,
            ...
            % Version 2
            [curr_trans, curr_err] = find_translation2(channels{1}-offset(1), channels{i}-offset(i), thresh, a2, tt);
        end
...
out.est_noise_std = noise_std_estimate; % Noise standard deviation estimated
